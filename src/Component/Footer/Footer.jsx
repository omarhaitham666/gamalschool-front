...
function Footer() {
  return (
    ...
    <span className="text-md text-white sm:text-center dark:text-gray-400"> 2024 <a href="#" className="hover:underline text-white"> Founded By Omar Haytham</a> :  Copyright © All Rights Reserved
    </span>
    <span className="text-md text-white sm:text-center dark:text-gray-400">  <a href="#" className="hover:underline text-white">special thanks for : </a>  E/Mohammed Elsayed
    </span>
    </div>   
