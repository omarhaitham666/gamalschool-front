        ...
        <div className="h-[450px] w-80 bg-blue-950 rounded-lg px-6 my-4 overflow-hidden">
          ...
          <form className="flex flex-col items-center" onSubmit={formik.handleSubmit}>
            <div className="w-full relative">
              <input className="w-full rounded-full py-2 px-4 my-2 bg-transparent border border-gray-200" 
                     type="text" name="name" onChange={formik.handleChange} 
                     value={formik.values.name} id="UserName" placeholder="اسم المستخدم" />
